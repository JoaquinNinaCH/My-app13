...
app.get('/api/musicas', musicaController.getMusicas);
app.get('/api/musicas/:id', musicaController.getMusicaById);
app.post('/api/musicas', musicaController.createMusica);
app.put('/api/musicas/:id', musicaController.updateMusica);
app.delete('/api/musicas/:id', musicaController.deleteMusica);
// Iniciar el servidor
app.listen(port, () => {
